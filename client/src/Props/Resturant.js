      ...
      <div className={style.resturant_container_body}>
        <div className={style.hotel_info_content}>
          <img
            ...
            alt="hotel"
            className={style.hotel_picture}
          />
        </div>
        <div className={style.hotel_info_content}>
          <div className={style.hotel_info_content_body}>
            <h2 className={` ${style.hotel2_Title} ${style.heading}`}>
              {props.hotelT}
            </h2>
          </div>
          <div className={style.hotel_info_content_body}>
            <div className={style.my_hotel}>
              ...
              <p className={` ${style.info_paragraph} ${style.my_property}`}>
                {props.location}
              </p>
            </div>
          </div>
          ...
          <div className={style.hotel_info_content_body}>
            <div className={style.total_reviews}>
              <span className={` ${style.points} ${style.my_property}`}>
                4.5
              </span>{" "}
              Excellent (245 reviesw )
            </div>
          </div>
          <div className={style.hotel_info_content_body}>
            <p className={` ${style.booked_time} ${style.my_property}`}>
        ...
        <div className={style.discounts_section}>
          <div className={style.discount_body}>
            ...
            <div className={style.discounts_cantents}>
              <p className={style.price}><strike>$250</strike></p>
            </div>
            <div className={style.discounts_cantents}>
              <p>
