  ...
  return (
    <div className={style.filter_sections}>
      <div className={style.filter_sections_container}>
        ...
        <div className={style.filter_cantent1}>
          <div className={style.cantent_body}>
            ...
            <img
              src={"../../../assets/img/blue_arrow.png"}
              alt=""
              className={style.blue_arrow}
            />
          </div>
          <div className={style.cantent_body}>
            <input
            ...
            />
            <SearchIcon className={style.search_filter} />
          </div>
        </div>
        <div className={style.filter_cantent1}>
          <div className={style.cantent_body}>
          ...
          <div className={style.cantent_body2}>
            ...
            <input
              type="range"
              className={` ${style.ranges_input} ${style.my_property}`}
            />
          </div>
        </div>
      </div>
      <div className={style.filter_content_section}>
        <h3 className={` ${style.headings} ${style.blue}`}>Property Types</h3>
        <img
          src={`../../../assets/img/blue_arrow.png`}
          alt=""
          className={style.arrow_menu}
        />
      </div>
      ...
      <div className={style.fields}>
        <Fields
          place="Internet/Wifi"
          image={`../../../assets/img/wifi.svg`}
          value="250"
        />
        <Fields
          place="Resturant"
          image={`../../../assets/img/knife.svg`}
          value="76"
        />
        <Fields
          place="Bar"
          image={"../../../assets/img/glass.svg"}
          value="89"
        />
        <Fields
          place="Swimming Pool"
        ...
        />
        <Fields
          place="Business Facilities"
          image={`../../../assets/img/business.svg`}
          value="63"
        />
        <Fields
          place="Spa/Wellness"
