        ...
        <div className={style.header_content}>
          ...
          <div className={style.header_input}>
            ...
            <input
              ...
              className={style.header_input_field}
            />
          </div>
        </div>
        <div className={style.header_content1}>
          <div className={style.header_menu}>
            <li className={style.header_lists}>
              <a
                className={`${style.header_links} ${style.my_property}`}
                href="/"
              >
                Home
              </a>
          ...
          <div className={style.header_account}>
            ...
            <div className={style.profile_info}>
              <h4 className={`${style.profile_name} ${style.my_property}`}>
                AshfakSyem
              </h4>
              <span className={`${style.profile_email} ${style.my_property}`}>
                ashfaksyem@gmail.com
              </span>
            </div>
          </div>
        </div>
