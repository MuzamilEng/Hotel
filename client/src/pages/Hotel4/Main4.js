          ...
          <div className={style.form4_body}>
            <div className={style.form4_inputs}>
              ...
              <div className={style.invoice}>
                ...
                <p className={`$ {style.invoice_number} ${style.my_property}`}>
                  Invoice Number - 16583
                </p>
              </div>
            </div>
            <div className={style.form4_inputs}>
              ...
              <div className={style.hotel_details}>
                <div className={style.detail_content}>
                  <div className={style.Hotel_detail}>
                    <h1 className={` ${style.detail_title} ${style.headings}`}>Hotel Details:</h1>
                ...
                <div className={style.detail_content}>
                  ...
                  <div className={style.bookingId}>
                    ...
                    <p className={`${style.booking_no} ${style.my_property}`}>HQM3947356</p>
                  </div>
                </div>
                <div className={style.detail_content}>
                  <div className={style.chechOut}>
                    <h4 className={` ${style.check_out} ${style.my_property} ${style.bold}`}>Check Out:</h4>
                    <p className={`${style.checkout_date} ${style.my_property}`}>10/11/2019</p>
                  </div>
                  <br />
                  <div className={style.payment}>
                    <h4 className={` ${style.payment_mode} ${style.my_property} ${style.bold}`}>
                      Payment Mode:
                    </h4>
                    <p className={`${style.credit_card} ${style.my_property}`}>Credit Card</p>
                  </div>
                </div>
                <div className={style.detail_content}>
                  <h4 className={` ${style.room} ${style.my_property} ${style.bold}`}>Rooms: </h4>
                  <p className={` ${style.room_info} ${style.my_property}`}>1</p>
                </div>
              </div>
            </div>
            {/* form section */}
            ...
            <div className={style.form_section}>
              <div className={style.grey_bg}>
                <TableInput desc="Description" rate="Rate" amount="Amount" />
              </div>
              <Table2
                desc="Room Charges"
                rate="$250 X 2 Nights X 1 Room"
                amount="$500"
              />
              <Table2 desc="Other Charges" rate="0.00" amount="0" />
              <Table2
                desc="Promotional Code"
                rate="SUMMERFUN-20% ONE TIME DISCOUNT"
                amount="-$100"
              />
              <div className={style.grey_bg}>
                <TableInput desc=" " rate="Sub Total:" amount="$400" />
              </div>
              <div className={style.grey_bg}>
                <TableInput desc=" " rate="Tax" amount="$40" />
              </div>
              <div className={style.grey_bg}>
              ...
              <div className={style.note_content}>
                <p className={`${style.note} ${style.my_property}`}>
                  ...
                  Excepturi fugit fugiat non adipisci ea cupiditate dolor sit
                  amet consectetur adipisicing elit. Excepturi fugit fugiat non
                  adipisci ea cupiditate.
                </p>
              </div>
              ...
              <div className={style.footer_note_section}>
                <p className={`${style.footer_note} ${style.my_property}`}>
                  Note: This is the computer generated recipit does not reqiure
