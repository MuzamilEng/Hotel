      ...
      <div className={style.h2_main_body}>
        ...
        <div className={style.main2_fields}>
          <div className={style.main2_inpt}>
            <Inputs
              holder="Enter City / Hotel"
              img={`../../../assets/img/map.svg`}
            />
            <Inputs
              holder="Check In"
              img={`../../../assets/img/calender.svg`}
            />
            <Inputs
              holder="Check Out"
              img={`../../../assets/img/calender.svg`}
              ...
              <div className={style.amdabad}>
                <div className={style.amda_para}>
                  <p className={` ${style.incl} ${style.my_property}`}>
                    <span className={` ${style.bold} ${style.my_property}`}>
                      Amdabad: 180 hotels found
                    </span>
                    &nbsp; &nbsp;
                    <span className={` ${style.yellow} ${style.my_property}`}>
                ...
                <div className={style.sort_input}>
                  ...
                  <input
                    type="text"
                    className={` ${style.sorts} ${style.my_property}`}
                    placeholder="Popularity"
                  />
                  <img
                    src={`../../../assets/img/up_down.jpg`}
                    alt=""
